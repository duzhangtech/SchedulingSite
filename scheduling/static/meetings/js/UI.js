...
var CalTopY;
var freakingBugFixer = 0;
$('#scrollWindow').scroll(function(){
  if ($("#scrollWindow").scrollTop() === 0 && freakingBugFixer === 0){
    CalTopY = CalTopY_base + 167/8.7;
    freakingBugFixer = 1;
  }
  else{
    CalTopY = CalTopY_base + $("#scrollWindow").scrollTop()/8.7;    
  }
});
            ...
            if (result[i] != '') {
              result[i] = result[i].trim();
                if (!validateEmail(result[i])) {
                    ...
                    if ( $("#error_1_id_share").html() != null) {
                      $("#error_1_id_share").html('<strong>' + result[i] + ' 不是一个有效的邮箱地址，请重新输入！</strong>');
                    }
                    else {
...
$("#name").bind('keydown', 'return', function a(){
    $("#nextStep").click();
}); 
$("#id_share").bind('keydown', 'return', function a(){
    $("#submit").click();
}); 
